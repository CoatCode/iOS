...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Realm/core/realm-sync.xcframework" "" "false" "ios-armv7_arm64/librealm-sync.a" "ios-arm64_i386_x86_64-simulator/librealm-sync.a" "ios-x86_64-maccatalyst/librealm-sync.a"
fi
